...
class UploadViewSet(ViewSet):
    ...
    def create(self, request):
        file_uploaded = request.FILES.get('filelocation')
        filesys = FileSystemStorage()
        filename = filesys.save(file_uploaded.title, file_uploaded)
        response = "POST API and you have uploaded a {} file".format(filename)
